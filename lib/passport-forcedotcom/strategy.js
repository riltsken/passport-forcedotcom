...
/**
 * Override the parseErrorResponse method. There are situations where salesforce will return
 * a different response which can't be parsed.
 */
Strategy.prototype.parseErrorResponse = function(body, status) {
    try {
        return Strategy.super_.prototype.parseErrorResponse.call(this);
    } catch(e) {
        return new TokenError('salesforce_oauth_error', body, null, status);
    }
};
